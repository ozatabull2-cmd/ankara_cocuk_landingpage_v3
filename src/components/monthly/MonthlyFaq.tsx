...
import { MONTHLY_FAQS, trackEvent } from '../../data/config';
...
export const MonthlyFaq: React.FC = () => {
  ...
  const toggleFaq = (id: string) => {
    ...
    if (nextState) {
      trackEvent('open_faq', { faq_id: id, page: 'monthly' });
    }
    setOpenId(nextState);
  };

  return (
    <section id="sss" className="py-14 sm:py-20 bg-[#F8FAFC] scroll-mt-20 border-t border-slate-200/90">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center space-y-2 mb-10">
          ...
          <p className="text-xs sm:text-sm text-slate-600">
            Aylık reklam sistemleri, veri mülkiyeti ve çalışma süreçleri hakkında detaylar.
          </p>
        </div>
